...
<div style="clear:both;"></div>
    <div class="HomeBottomBackground">
    <div class="container-fluid">
        <section class="row">
            <a class="DeptTitle hidden-xs hidden-sm" href="#">Department<br />&nbsp;&nbsp;of Pediatrics</a>
            <a class="MedSchoolLogo" href="#"><img alt="" class="img-responsive hidden-xs hidden-sm" src="<%=SkinPath %>images/WUSLTMedLogo2.png" /></a>
            <div class="SocialMediaArea hidden-xs hidden-sm">
                <a class="Media" href="#"><img alt="" src="<%=SkinPath %>images/FacebookIcon.png" style="margin-bottom:8px;" /></a><br />
                <a class="Media"  href="#"><img alt="" src="<%=SkinPath %>images/TwitterIcon.png" style="margin-bottom:8px;" /></a><br />
                <a class="Media"  href="#"><img alt="" src="<%=SkinPath %>images/YouTubeIcon.png" style="" /></a>
            </div>
            <div class="fill-screen img-responsive" style="background-image: url('<%=GetRandomImage()%>');">
                <div class="down-button">
                    <a class="btn" href="#ButtonInfo"><img alt="" src="<%=SkinPath %>images/PhotoArrow.png" style="" /></a>
                </div>
            </div>
        </section>
        <div class="row container"  id="ButtonInfo" style="margin-left:auto; margin-right:auto;">
        <div class="under">
        <img alt="" class="img-responsive hidden-xs hidden-sm" src="<%=SkinPath %>images/Brookings.png" style="" usemap="#BrookingsMap"/>
        </div>
<div class="over">
    <div class="row container VideoNewsText">Department of Pediatrics <a class="VideoNewsText" href="#">Videos</a> & <a class="VideoNewsText" href="#">News</a></div>
          <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 pull-left">
            <div id="VideoPane" runat="server" style="margin-bottom:15px;"></div>  
          </div>
          <div class="col-xs-12 col-sm-12 col-md-5  col-lg-5 pull-right">
            <div id="NewsPane" runat="server"></div> 
          </div>
        </div>
    </div>
