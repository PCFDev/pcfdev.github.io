...
<div class="body">
  ...
  <div class="container">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li><a href="/hometest/LabMedTest.aspx">Lab Med Test</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li><a href="/hometest/LabMedTest.aspx">Laboratory Medicine</a></li>
            <li class="divider hidden-md hidden-lg"></li>
                <li><a class="hidden-md hidden-lg SecPage" href="/labmed/Laboratories.aspx">Laboratories</a></li>
                <li><a class="hidden-md hidden-lg SecPage" href="/labmed/Links.aspx">Links</a></li>
                <li><a class="hidden-md hidden-lg SecPage" href="/labmed/InformationSystems.aspx">Information Systems</a></li>
            <li class="divider hidden-md hidden-lg"></li>
            <li><a href="/nephrology/Home.aspx">Nephrology</a></li>
            <li><a href="/labmed/Links.aspx">Newborn Medicine</a></li>
    ...
    <div class="DivMiddleBackground">
        <div class="container-fluid">
            <section class="row container" style="margin-left:auto;margin-right:auto;">
                <img alt="" class="img-responsive hidden-sm hidden-md hidden-lg DivMobileImage" src="<%=SkinPath %>images/MobileDivMainImages/LabMedPhoto.png" />
	            <div class="DivMainImage hidden-xs" style="">   
    ...
    <div class="TriSection">
        <section id="DivisionsThreeAreas" class="container">
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                <div class="DivMainContentBody2col1Stlyle DivInsideStyle">
                    <div id="DivMenuPane" runat="server"></div>
                </div>
                <div id="FacultyPane" runat="server"></div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-5 col-xs-12">
                <div id="ContentPane" runat="server"></div><br />
                <h2>Mission Statement</h2>
                <div class="table-responsive">
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            <td><img alt="" src="/portals/labmed/diagnose.png" class="DivIcon" /></td>
                            <td>Provide state-of-the-art, child-oriented laboratory testing for inpatients and outpatients at St. Louis Children's Hospital, serving as a resource for diagnosis, therapy and consultation.</td>
                        </tr>
                        <tr>
                            <td><img alt="" style="" src="/portals/labmed/learn.png" class="DivIcon" /></td>
                            <td>Participate in teaching and training in laboratory medicine and other related areas within the medical center.</td>
                        </tr>
                        <tr>
                            <td><img alt="" src="/portals/labmed/research.png" class="DivIcon" /></td>
                            <td>Develop a critical mass of laboratory medicine professionals and progress towards recognition as a center of excellence in pediatric laboratory medicine.</td>
                        </tr>
                    </tbody>
                </table>
                </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div id="ContactUsPane" runat="server"></div>
            </div>
        </section>
    </div>
