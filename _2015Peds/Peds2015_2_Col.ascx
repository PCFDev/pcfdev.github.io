    ...
    <div class="MiddleBackground">
        <div class="container-fluid">
            <section class="row container" style="margin-left:auto;margin-right:auto;">
	            <div class="MainContentBody2col1">
		            <div class="MainContentBody2col1Stlyle pull-left hidden-xs hidden-sm">
			            <div class="SecNavStyle">
		                    <ddr:MENU id="MENU1" NodeSelector="RootChildren" runat="server" menustyle="MenuTemplateFolder/ULTokens"/>     
			            </div>
		            </div>
	            </div>	
	            <div class="MainContentBody2col2 pull-right" style="">
